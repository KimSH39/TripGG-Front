      ...
      <div className="min-h-screen bg-gray-50 pb-20 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <img src={chat?.avatar || "/placeholder.svg"} alt={chat?.name} className="w-8 h-8 rounded-full" />
            <div>
            ...
            <div key={msg.id} className={`flex ${msg.isMine ? "justify-end" : "justify-start"}`}>
              <div
                className={`max-w-xs lg:max-w-md px-4 py-2 rounded-2xl ${
                  msg.isMine ? "bg-blue-500 text-white" : "bg-white text-gray-800 border border-gray-200"
                }`}
              >
        ...
        <div className="bg-white border-t border-gray-200 p-4">
          <div className="flex items-center space-x-2">
            ...
            <Button onClick={handleSendMessage} size="sm" className="bg-blue-500 hover:bg-blue-600 rounded-full px-4">
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b border-gray-200 p-4">
        ...
        <div className="relative">
          ...
          <Input placeholder="채팅방 검색" className="pl-10 bg-gray-100 border-0 focus:ring-2 focus:ring-blue-500" />
        </div>
      </div>
