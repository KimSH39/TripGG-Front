    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="p-6 text-center">
        <div className="relative inline-block mb-4">
          <img src={user.avatar || "/placeholder.svg"} alt={user.name} className="w-20 h-20 rounded-full mx-auto" />
      ...
      <BottomNavigation currentTab="mytravel" />
    </div>
  )
              ...
              <div className="flex-1">
                ...
                <span
                  className={`text-xs px-2 py-1 rounded ${
                    schedule.status === "완료" ? "bg-green-50 text-green-600" : "bg-orange-50 text-orange-600"
                  }`}
                >
                  {schedule.status}
                </span>
